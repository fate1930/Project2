...
<head>
    ...
    function addp($number){
        if($number == 0){
            echo "<script>function addpages(){
                           var addpage = document.getElementById('numbers2');
                           ...
                           document.getElementById('pic1').getElementsByClassName('title')[0].textContent = '您还没有上传照片';
                      }
                      addpages();
                  </script>";
        }
    ...
    <?php function getImage(){
        ...
        try {
            ...
            $pro = "select * from travelimage where UID='$userid' limit $prepa1,4";
            $pro1 = $pdo->query($pro);
            $count = "select count(*) as 'count' from travelimage where UID='$userid'";
            ...
            while($pro2 = $pro1->fetch()){
                ...
                while ($row = $result->fetch()) {
                    ...
                    echo "<script> function change(){
                      ...
                      var aim2 = document.getElementsByClassName('button6')[i-1];
                      aim2.style.display = 'block';
                      document.getElementById('button' + i).name = path;
                      document.getElementById('nbutton' + i).name = path;
                      }
                      change();
                      </script>";
                    $i++;
...
<div class="clear"></div>
<div id="container4">
    <h1 class="mchange">My Photo</h1>
    <div class="inner" id="pic1"><div class="brief"><p class="title"></p><br><p class="intro"></p></div><input id="button1" type="button" value="Delete" class="button5" style="display:none" onclick="deletepic(1)"><input id="nbutton1" type="button" value="Modify" class="button6" style="display:none" onclick="modifypic(1)"></div>
    <div class="inner" id="pic2"><div class="brief"><p class="title"></p><br><p class="intro"></p></div><input id="button2" type="button" value="Delete" class="button5" style="display:none" onclick="deletepic(2)"><input id="nbutton2" type="button" value="Modify" class="button6" style="display:none" onclick="modifypic(2)"></div>
    <div class="inner" id="pic3"><div class="brief"><p class="title"></p><br><p class="intro"></p></div><input id="button3" type="button" value="Delete" class="button5" style="display:none" onclick="deletepic(3)"><input id="nbutton3" type="button" value="Modify" class="button6" style="display:none" onclick="modifypic(3)"></div>
    <div class="inner" id="pic4"><div class="brief"><p class="title"></p><br><p class="intro"></p></div><input id="button4" type="button" value="Delete" class="button5" style="display:none" onclick="deletepic(4)"><input id="nbutton4" type="button" value="Modify" class="button6" style="display:none" onclick="modifypic(4)"></div>
    <div id="numbers2"></div>
    <?php getImage();?>
</div>
<script>
    function deletepic(value) {
        ...
        s = 'mypicture1.php?target=' + target;
        window.location = s;
    }
    function modifypic(value) {
        var path = document.getElementById('nbutton' + value).name;
        s = 'upload.php?path=' + path;
        window.location = s;
    }
</script>
<footer id="foot">
